...
public class ContainerInformacoes  {
	...
	private informaçoes informaçoes;
	private alugados alugados;
	

	public ContainerInformacoes() {
		this.informaçoes = new informaçoes();
	...
	public JPanel getPanel() {
		this.detalhesCliente.add(informaçoes.getPanel(), BorderLayout.NORTH);
...
//-----------------------------------------------
 class informaçoes  {
	...
	/*public informaçoes() {
		...
		this.LEndereco = new JLabel("Endereço:");
	...
	public JPanel getPanel() {
        ...
        public void getCadastro(){
            //aqui é só uma tentativa de checar se estava tudo certo, o metodo para conseguir as informações
            //o metodo para conseguir as informações especificas deve ser por aqui
